...
## Project Structure
    ...
    ├── testapiautosetting_127064  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127064`
...
2. Clone this repo and `cd testapiautosetting_127064`
